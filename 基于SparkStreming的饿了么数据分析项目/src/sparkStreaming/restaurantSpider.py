...
latiAndlongiList = [
    [[31.969385, 118.699734], [32.117435, 118.951682]],
    [[39.862371, 116.295577], [39.973552, 116.453055]],
    [[23.108876, 113.238548], [23.155352, 113.344978]],
    [[30.629924, 103.895822], [30.790188, 104.138172]],
    [[41.772306, 123.437263], [41.817686, 123.479084]]
]
...
for i in range(1, 5):
    ...
    latiStep = (latitudeMax - latitudeMin) / 5
    longiStep = (longitudeMax - longitudeMin) / 5
    ## 每个城市遍历5x5=25个经纬度
    ...
    while (latitudeMin < latitudeMax):
        while (longitudeMin < longitudeMax):
            ...
            for j in range(0, 500, 30):
                ...
                notRepeatJson = functions.getNotRepeatJson(functions.stringToJson(content), shopIdList) ##通过店铺id列表对当前Json进行去重
